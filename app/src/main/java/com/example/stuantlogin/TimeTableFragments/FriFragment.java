...
public class FriFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.fri_fragment, container, false);

        tvHr1 = view.findViewById(R.id.tvFDFirstPer);
        tvHr2 = view.findViewById(R.id.tvFDSecondPer);
        tvHr3 = view.findViewById(R.id.tvFDThirdPer);
        tvHr4 = view.findViewById(R.id.tvFDfourthPer);
        tvHr5 = view.findViewById(R.id.tvFDfifthPer);
        tvHr6 = view.findViewById(R.id.tvFDsixthPer);
        tvHr7 = view.findViewById(R.id.tvFDSeventhPer);
        tvHr8 = view.findViewById(R.id.tvFDEighPer);
        ...
        uid.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference("TimeTable").child(std).child("FriDay");
