...
public class WedFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.wed_fragment, container, false);

        tvHr1 = view.findViewById(R.id.tvWDFirstPer);
        tvHr2 = view.findViewById(R.id.tvWDSecondPer);
        tvHr3 = view.findViewById(R.id.tvWDThirdPer);
        tvHr4 = view.findViewById(R.id.tvWDfourthPer);
        tvHr5 = view.findViewById(R.id.tvWDfifthPer);
        tvHr6 = view.findViewById(R.id.tvWDsixthPer);
        tvHr7 = view.findViewById(R.id.tvWDSeventhPer);
        tvHr8 = view.findViewById(R.id.tvWDEighPer);
        ...
        uid.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference("TimeTable").child(std).child("WednesDay");
