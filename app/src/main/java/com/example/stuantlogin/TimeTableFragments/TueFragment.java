...
public class TueFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.tue_fragment, container, false);

        tvHr1 = view.findViewById(R.id.tvTDFirstPer);
        tvHr2 = view.findViewById(R.id.tvTDSecondPer);
        tvHr3 = view.findViewById(R.id.tvTDThirdPer);
        tvHr4 = view.findViewById(R.id.tvTDfourthPer);
        tvHr5 = view.findViewById(R.id.tvTDfifthPer);
        tvHr6 = view.findViewById(R.id.tvTDsixthPer);
        tvHr7 = view.findViewById(R.id.tvTDSeventhPer);
        tvHr8 = view.findViewById(R.id.tvTDEighPer);
        ...
        uid.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference("TimeTable").child(std).child("TuesDay");
